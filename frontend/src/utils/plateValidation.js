 ...
 */
export const validateIndianPlate = (plate) => {
    if (!plate) return { isValid: true, error: null, type: null }; // Allow empty for optional fields
